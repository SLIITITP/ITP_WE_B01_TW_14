...
const deliverySchema = new Schema({
  //mongodn wala special feature ekak thamai api object ID ekak generate kre nathi unath mokakhari document ekak insert karama ekata adala auto object ID ekak generate karala denwa
